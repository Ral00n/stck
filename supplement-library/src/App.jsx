...
import {
  ...
  Clock, Beaker, Flame, Shield, Timer, TrendingUp, SlidersHorizontal, Globe,
} from "lucide-react";
  ...
  return (
    <div className="nk-root">
      <style>{`
        ...
        html, body { background:#0D0D0D; color:#F5F5F5; margin:0; color-scheme:dark; }
        .nk-root {
          ...
          color:#F5F5F5; font-family:'Inter',sans-serif; min-height:100vh;
        }
        ...
        .nk-muted { color:#9A9A9A; }
        .nk-accent-text { color:#FF3B30; }
        .nk-red-text { color:#FF3B30; }
        ::selection { background:#FF3B30; color:#fff; }

        .nk-hero { position:relative; overflow:hidden; border-bottom:1px solid #232323; padding:56px 24px 44px; background:
          repeating-linear-gradient(115deg, transparent 0 64px, rgba(255,59,48,0.08) 64px 66px), #0D0D0D; }
        ...
        .nk-hero-eyebrow { display:flex; align-items:center; gap:8px; color:#FF3B30; margin-bottom:14px; font-size:12px; }
        .nk-hero-title { font-size:4rem; line-height:0.88; font-weight:400; margin:0; color:#F5F5F5; }
        .nk-hero-title .nk-red-text { background:linear-gradient(90deg, #FF3B30, #FFB020); -webkit-background-clip:text; background-clip:text; -webkit-text-fill-color:transparent; }
        .nk-hero-sub { margin-top:18px; max-width:560px; color:#B4B4B4; font-size:16px; line-height:1.6; font-family:'Barlow Condensed',sans-serif; letter-spacing:0.01em; }

        .nk-bar { position:fixed; top:0; left:0; right:0; z-index:50; background:#0D0D0D; border-bottom:1px solid #232323; padding:14px 24px; box-shadow:0 8px 24px rgba(0,0,0,0.5); }
        .nk-bar-inner { max-width:960px; margin:0 auto; display:flex; flex-direction:column; gap:10px; }
        .nk-tabs-row { margin-bottom:10px; overflow-x:auto; -webkit-overflow-scrolling:touch; }
        .nk-search-row { display:flex; gap:8px; flex-wrap:wrap; }
        .nk-tab-group { display:inline-flex; gap:4px; flex-shrink:0; background:#161616; border:1px solid #232323; border-radius:999px; padding:3px; }
        .nk-tab-btn { padding:0 14px; height:32px; border-radius:999px; font-size:12px; font-weight:600; border:none; color:#8B8B8B; background:transparent; cursor:pointer; white-space:nowrap; }
        .nk-tab-btn.is-active { background:#F5F5F5; color:#0D0D0D; }
        .nk-lang-group { display:flex; gap:4px; flex-shrink:0; }
        .nk-lang-btn { padding:0 10px; height:38px; border-radius:999px; font-size:11px; font-weight:700; border:1px solid #2A2A2A; color:#8B8B8B; background:transparent; cursor:pointer; font-family:'JetBrains Mono',monospace; }
        .nk-lang-btn.is-active { background:#F5F5F5; color:#0D0D0D; border-color:#F5F5F5; }
        .nk-search-wrap { position:relative; flex:1 1 160px; min-width:0; }
        .nk-search-icon { position:absolute; left:14px; top:50%; transform:translateY(-50%); color:#6B6B6B; }
        .nk-search-input { width:100%; background:#161616; border:1px solid #2A2A2A; border-radius:999px; padding:10px 40px; font-size:14px; color:#F5F5F5; outline:none; box-sizing:border-box; height:38px; }
        .nk-search-input::placeholder { color:#5E5E5E; }
        .nk-search-input:focus { border-color:#FF3B30; }
        .nk-search-clear { position:absolute; right:14px; top:50%; transform:translateY(-50%); color:#6B6B6B; background:none; border:none; cursor:pointer; }
        .nk-bar-controls { display:flex; gap:8px; flex-shrink:0; flex-wrap:wrap; }
        .nk-filter-toggle { display:flex; align-items:center; gap:6px; padding:0 16px; height:38px; border-radius:999px; font-size:12px; font-weight:700; border:1px solid #2A2A2A; color:#B4B4B4; background:transparent; cursor:pointer; white-space:nowrap; }
        .nk-filter-toggle.is-active { background:#FF3B30; color:#fff; border-color:#FF3B30; }
        .nk-chip-row { display:flex; flex-wrap:wrap; gap:6px; align-items:center; }
        .nk-chip-label { font-size:11px; color:#5E5E5E; margin-right:2px; }
        .nk-chip { display:flex; align-items:center; gap:6px; padding:5px 14px; border-radius:999px; font-size:12px; font-weight:500; border:1px solid #2A2A2A; color:#B4B4B4; background:transparent; cursor:pointer; }
        .nk-chip.is-active { background:#FF3B30; color:#fff; border-color:#FF3B30; }

        .nk-main { max-width:960px; margin:0 auto; padding:40px 24px; }
        .nk-count-row { display:flex; justify-content:space-between; font-size:11px; color:#5E5E5E; margin-bottom:20px; }
        ...
        .nk-card { position:relative; overflow:hidden; text-align:left; background:#141414; border:1px solid #232323; border-left:3px solid var(--cat-accent, #232323); border-radius:16px; padding:20px; cursor:pointer; transition:transform 0.15s ease, border-color 0.15s ease; }
        .nk-card:hover { border-color:#FF3B30; border-left-color:var(--cat-accent, #FF3B30); transform:translateY(-3px); }
        .nk-card-watermark { position:absolute; top:-6px; right:8px; font-size:52px; font-weight:800; color:#1D1D1D; pointer-events:none; user-select:none; line-height:1; }
        .nk-card-top { display:flex; align-items:flex-start; justify-content:space-between; margin-bottom:16px; position:relative; }
        .nk-mvp-tag { font-size:9px; font-weight:800; letter-spacing:0.08em; color:#0D0D0D; background:#FFB020; padding:2px 6px; border-radius:4px; }
        .nk-card-cat { display:flex; align-items:center; gap:6px; font-size:11px; color:#9A9A9A; margin-bottom:6px; }
        .nk-card-title { font-size:1.9rem; line-height:0.95; font-weight:400; margin:0 0 4px; color:#F5F5F5; }
        .nk-card:hover .nk-card-title { color:#FF3B30; }
        .nk-card-titleEn { font-size:10px; color:#5E5E5E; margin-bottom:10px; }
        .nk-card-tagline { font-size:13.5px; color:#9A9A9A; line-height:1.5; }

        .nk-rate-badge { display:flex; flex-direction:column; align-items:center; justify-content:center; width:44px; height:44px; border-radius:10px; border:2px solid; background:#0D0D0D; flex-shrink:0; }
        ...
        .nk-rate-tag { font-size:8px; color:#5E5E5E; margin-top:2px; letter-spacing:0.1em; }
        .nk-rate-hi { border-color:#FFB020; } .nk-rate-hi .nk-rate-num { color:#FFB020; }
        .nk-rate-mid { border-color:#FF3B30; } .nk-rate-mid .nk-rate-num { color:#FF3B30; }
        .nk-rate-lo { border-color:#5E5E5E; } .nk-rate-lo .nk-rate-num { color:#B4B4B4; }

        .nk-empty { text-align:center; padding:90px 0; color:#9A9A9A; }
        .nk-empty h3 { font-size:2.2rem; margin-bottom:8px; color:#F5F5F5; }

        .nk-footer { border-top:1px solid #232323; padding:40px 24px 28px; text-align:center; }
        .nk-footer-about { max-width:480px; margin:0 auto 28px; padding-bottom:28px; border-bottom:1px solid #1C1C1C; }
        .nk-footer-about h4 { font-size:13px; letter-spacing:0.1em; text-transform:uppercase; color:#F5F5F5; margin:0 0 10px; font-family:'Barlow Condensed',sans-serif; }
        .nk-footer-about p { font-size:13px; color:#9A9A9A; line-height:1.6; margin:0; }
        .nk-footer-disclaimer { font-size:11px; color:#5E5E5E; max-width:420px; margin:0 auto; line-height:1.6; font-family:'JetBrains Mono',monospace; }
        .nk-footer-copyright { font-size:11px; color:#3F3F3F; margin:16px 0 0; font-family:'JetBrains Mono',monospace; }
        .nk-footer-legal-link { background:none; border:none; color:#6B6B6B; font-size:11px; text-decoration:underline; text-underline-offset:3px; cursor:pointer; margin-top:14px; font-family:'JetBrains Mono',monospace; }
        .nk-footer-legal-link:hover { color:#FF3B30; }
        .nk-legal-list { display:flex; flex-direction:column; gap:16px; }
        .nk-legal-list p { font-size:13.5px; color:#B4B4B4; line-height:1.7; margin:0; }
        .nk-legal-list strong { color:#F5F5F5; }
        ...
        .nk-modal-panel { position:relative; width:100%; max-width:640px; max-height:90vh; overflow-y:auto; background:#141414; border:1px solid #2A2A2A; border-radius:24px 24px 0 0; }
        @media (min-width:768px) { .nk-modal-panel { border-radius:24px; } }
        .nk-modal-head { position:sticky; top:0; background:#141414; border-bottom:1px solid #232323; padding:16px 28px; display:flex; align-items:center; justify-content:space-between; z-index:1; }
        .nk-modal-close { background:none; border:none; color:#9A9A9A; cursor:pointer; padding:4px; }
        .nk-modal-close:hover { color:#F5F5F5; }
        ...
        .nk-modal-title { font-size:2.7rem; line-height:0.95; font-weight:400; margin:0; color:#F5F5F5; }
        .nk-modal-titleEn { font-size:12px; color:#5E5E5E; margin-top:8px; font-family:'JetBrains Mono',monospace; }
        .nk-modal-tagline { color:#FF3B30; font-size:16px; font-style:italic; margin:16px 0 22px; font-family:'Barlow Condensed',sans-serif; }
        .nk-goal-chips { display:flex; flex-wrap:wrap; gap:6px; margin-bottom:26px; }
        .nk-goal-chip { font-size:11px; padding:4px 10px; border-radius:999px; background:#232323; color:#B4B4B4; font-family:'JetBrains Mono',monospace; }
        .nk-detail-note { font-size:11px; color:#6B6B6B; font-style:italic; margin-bottom:20px; }
        .nk-detail-tabs { display:flex; gap:4px; background:#0D0D0D; border:1px solid #232323; border-radius:999px; padding:3px; margin-bottom:22px; }
        .nk-detail-tab { flex:1; padding:8px 10px; border-radius:999px; border:none; background:transparent; color:#8B8B8B; font-size:12px; font-weight:600; cursor:pointer; font-family:'Barlow Condensed',sans-serif; letter-spacing:0.04em; }
        .nk-detail-tab.is-active { background:#FF3B30; color:#fff; }

        .nk-statbar-row { margin-bottom:10px; }
        .nk-statbar-label { display:flex; justify-content:space-between; font-size:10px; letter-spacing:0.14em; text-transform:uppercase; color:#9A9A9A; margin-bottom:5px; }
        .nk-statbar-track { height:6px; border-radius:999px; background:#232323; overflow:hidden; }
        .nk-statbar-fill { height:100%; border-radius:999px; background:linear-gradient(90deg,#FF3B30,#FFB020); }

        .nk-section { margin-bottom:22px; }
        .nk-section h4 { font-size:12px; letter-spacing:0.14em; text-transform:uppercase; color:#9A9A9A; margin:0 0 10px; font-family:'Barlow Condensed',sans-serif; }
        .nk-section p { font-size:14px; color:#DEDEDE; line-height:1.6; margin:0; }
        .nk-benefit-list { list-style:none; margin:0; padding:0; display:flex; flex-direction:column; gap:8px; }
        .nk-benefit-list li { display:flex; gap:10px; font-size:14px; color:#DEDEDE; line-height:1.5; }
        .nk-benefit-list svg { color:#D7FF1E; flex-shrink:0; margin-top:2px; }
        ...
        .nk-info-box { background:#0D0D0D; border:1px solid #232323; border-radius:14px; padding:16px; }
        .nk-info-box-head { display:flex; align-items:center; gap:6px; font-size:11px; letter-spacing:0.12em; text-transform:uppercase; color:#9A9A9A; margin-bottom:8px; font-family:'Barlow Condensed',sans-serif; }
        .nk-info-box p { font-size:14px; color:#F5F5F5; line-height:1.5; margin:0; }

        .nk-caution-box { background:#221109; border:1px solid #4A2416; border-radius:14px; padding:16px; }
        .nk-caution-head { display:flex; align-items:center; gap:6px; font-size:11px; letter-spacing:0.12em; text-transform:uppercase; color:#FF9F3C; margin-bottom:8px; font-family:'Barlow Condensed',sans-serif; }
        .nk-caution-box p { font-size:14px; color:#E4CBB5; line-height:1.5; margin:0; }

        .nk-news-list { display:flex; flex-direction:column; }
        .nk-news-item { display:flex; gap:12px; padding:14px 0; border-top:1px solid #232323; }
        .nk-news-item:first-child { border-top:none; padding-top:0; }
        .nk-news-dot { width:6px; height:6px; border-radius:999px; background:#FF3B30; margin-top:7px; flex-shrink:0; }
        .nk-news-tag { display:inline-block; font-size:9px; font-weight:700; letter-spacing:0.08em; text-transform:uppercase; color:#FF3B30; font-family:'JetBrains Mono',monospace; margin-bottom:4px; }
        .nk-news-headline { font-size:15px; font-weight:700; color:#F5F5F5; line-height:1.35; margin:0 0 4px; }
        .nk-news-takeaway { font-size:13px; color:#9A9A9A; line-height:1.5; margin:0; }

        .nk-feed-list { display:flex; flex-direction:column; }
        .nk-feed-item { display:flex; gap:14px; text-align:left; background:none; border:none; border-top:1px solid #232323; padding:20px 0; cursor:pointer; color:inherit; font:inherit; width:100%; }
        .nk-feed-item:first-child { border-top:none; }
        .nk-feed-item:hover .nk-news-headline { color:#FF3B30; }
        .nk-feed-meta { display:flex; align-items:center; gap:10px; margin-bottom:6px; flex-wrap:wrap; }
        .nk-feed-ingredient { font-size:10px; color:#5E5E5E; }
        .nk-feed-item .nk-news-headline { font-size:17px; }

        .nk-stack-clear { background:none; border:1px solid #2A2A2A; color:#9A9A9A; font-size:11px; padding:4px 12px; border-radius:999px; cursor:pointer; font-family:'JetBrains Mono',monospace; }
        .nk-stack-clear:hover { border-color:#FF3B30; color:#FF3B30; }
        .nk-stack-picker { display:flex; flex-wrap:wrap; gap:8px; margin-bottom:32px; }
        .nk-stack-chip { padding:8px 16px; border-radius:999px; font-size:13px; border:1px solid #2A2A2A; background:#141414; color:#B4B4B4; cursor:pointer; transition:all 0.15s ease; }
        .nk-stack-chip:hover { border-color:#5E5E5E; }
        .nk-stack-chip.is-active { background:#FF3B30; border-color:#FF3B30; color:#fff; font-weight:600; }
        .nk-stack-results { display:flex; flex-direction:column; gap:32px; }
        .nk-stack-section h4 { font-size:13px; letter-spacing:0.12em; text-transform:uppercase; color:#F5F5F5; margin:0 0 14px; font-family:'Barlow Condensed',sans-serif; }
        .nk-stack-note { font-size:13px; color:#6B6B6B; line-height:1.6; font-style:italic; }
        ...
        .nk-stack-list-good li { background:#0F1B14; border-left-color:#3DDC84; color:#C9E8D4; }
        .nk-stack-list-caution li { background:#221109; border-left-color:#FF9F3C; color:#E4CBB5; }
        ...
        .nk-schedule-col { background:#141414; border:1px solid #232323; border-radius:14px; padding:14px; }
        .nk-schedule-label { font-size:11px; letter-spacing:0.1em; text-transform:uppercase; color:#FF3B30; margin-bottom:10px; font-family:'JetBrains Mono',monospace; }
        .nk-schedule-item { display:block; width:100%; text-align:left; background:none; border:none; border-top:1px solid #1C1C1C; padding:8px 0; font-size:13px; color:#DEDEDE; cursor:pointer; }
        .nk-schedule-item:first-child { border-top:none; }
        .nk-schedule-item:hover { color:#FF3B30; }
      `}</style>
        ...
        <>
          ...
          <header className="nk-hero">
            <div className="nk-hero-inner">
              <div className="nk-hero-eyebrow nk-mono">
